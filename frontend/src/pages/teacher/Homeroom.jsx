          ...
          {homerooms.map((hm) => (
            <div key={hm.classId} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <Link to={`/teacher/attendance?classId=${hm.classId}${hm.sectionId ? `&sectionId=${hm.sectionId}` : ''}`} className="inline-block rounded-xl bg-[#203e4f] px-5 py-3 text-sm font-bold text-white transition hover:bg-[#172d3a] shadow-xs">Open Attendance</Link>
