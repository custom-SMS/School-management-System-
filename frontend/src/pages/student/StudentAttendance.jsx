...
export default function StudentAttendance() {
  ...
  // Build a status map from the recent attendance feed (date -> status).
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              ...
              {recent.length === 0 && <tr><td colSpan="2" className="py-8 text-center text-emerald-600 font-semibold">✅ No recent absences — perfect record!</td></tr>}
            </tbody>
          </table>
        </div>
      </section>
