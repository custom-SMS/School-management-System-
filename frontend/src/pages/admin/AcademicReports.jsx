    ...
    <AdminLayout pageTitle="Reporting Module">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition">
          ...
          <button onClick={() => navigate('/admin/reports/attendance')} className="w-full py-2 bg-gray-50 text-slate-600 font-bold rounded-lg hover:bg-gray-100 transition">Generate Report</button>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition">
          ...
          <button onClick={() => navigate('/admin/reports/enrollment')} className="w-full py-2 bg-gray-50 text-gray-600 font-bold rounded-lg hover:bg-gray-100 transition">Generate Report</button>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition">
          ...
          <button onClick={() => navigate('/admin/reports/financial')} className="w-full py-2 bg-gray-50 text-gray-600 font-bold rounded-lg hover:bg-gray-100 transition">View Dashboard</button>
        </div>
