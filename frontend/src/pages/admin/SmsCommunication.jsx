        ...
        <div className="lg:col-span-1">
            <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm sticky top-24">
                ...
                <button
                    ...
                    className="w-full flex justify-center items-center gap-2 rounded-xl bg-[#203e4f] py-3 px-4 text-sm font-bold text-white shadow-xs transition-transform active:scale-[0.98] hover:bg-[#172d3a] disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100"
                >
                    {sending ? (
                        <>
