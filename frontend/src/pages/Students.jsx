    ...
    <AdminLayout pageTitle="System Management" headerAction={
      canManage && (
        <button
          ...
          className="flex items-center gap-2 flex-nowrap whitespace-nowrap shrink-0 rounded-xl bg-[#203e4f] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#172d3a] shadow-xs"
        >
          <svg className="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
          Enroll New Student
        </button>
      )
    }>
