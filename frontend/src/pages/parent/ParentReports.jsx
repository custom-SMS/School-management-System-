...
export default function ParentReports() {
  ...
  const level = selectedChild?.profile?.grade || '—';
  ...
  return (
    <ParentLayout kids={children} childId={childId} onSelectChild={setChildId}>
      <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-slate-900">Academic Reports</h1>
          <p className="text-sm text-slate-500">{name} · {level} · official records and transcript.</p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1.7fr_1fr]">
            ...
            <aside className="space-y-4">
              ...
              <div className="rounded-2xl bg-slate-900 p-6 text-white shadow-sm">
                ...
                <p className="mt-1 text-sm text-slate-400">Discrepancy in {name}'s marks? Open a formal review ticket.</p>
