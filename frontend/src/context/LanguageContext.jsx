...
const translations = {
  en: {
    ...
    textNotesSubmission: 'Text Notes Submission',
    submitAssignment: 'Submit Assignment',
    turnInWork: 'Turn In Work',
    alreadySubmitted: 'Work already submitted',
    noAssignmentsFound: 'No assignments published for your classes yet.',
    noMaterialsFound: 'No study materials available yet.',
    parentCourseworkTitle: 'Coursework & Study Materials',
    parentCourseworkSub: 'Monitor assignments, submission statuses, teacher feedback, and download class materials for {name}.',
    studentCourseworkTitle: 'Coursework & Study Materials',
    studentCourseworkSub: 'Submit your homework assignments, view grading feedback, and access teacher-provided resources.',
    downloadDirectly: 'Download Resource',
    uploadSolutionFile: 'Upload Solution File',
    writeSolutionNotes: 'Write Solution / Notes',
    submissionModalTitle: 'Submit Assignment: {title}',
    fileAttached: 'File Attached',
    dragOrClickToUpload: 'Click or drag file to upload',
    allowedFileTypes: 'PDF, DOCX, ZIP, PNG, JPG (up to 25MB)',
    ...
    reportsSub: 'Academic report card information.',
    inPersonDistributionTitle: 'Report Cards Are Distributed In Person',
    inPersonDistributionNotice: 'Official report cards are generated by the school and printed for distribution. They are not available digitally through this portal. Students are required to visit the school to collect their printed report card.',
    monitorPerformanceSubject: 'Monitor Performance by Subject',
    monitorPerformanceSubjectSub: 'You can monitor academic performance subject by subject from the Academics page at any time.',
    collectReportCard: 'Collect Your Report Card',
    collectReportCardSub: 'Visit the school administration office during working hours to receive your official printed report card.',
    collectReportCardParentSub: 'Please visit the school administration office during working hours so {name} can receive their official printed report card.',
  ...
  am: {
    ...
    // Coursework & Materials
    coursework: 'የቤት ሥራ እና ማቴሪያሎች',
    assignments: 'የቤት ሥራዎች',
    studyMaterials: 'የማጥኛ ማቴሪያሎች',
    submissions: 'የተላኩ ሥራዎች',
    submitWork: 'ሥራ አስገባ',
    submitted: 'ተልኳል',
    graded: 'ታርሟል',
    late: 'ዘግይቷል',
    ...
    fileSubmission: 'የፋይል ማስረከቢያ',
    textNotesSubmission: 'የጽሑፍ ማስታወሻ ማስረከቢያ',
    submitAssignment: 'የቤት ሥራ አስረክብ',
    turnInWork: 'አስረክብ',
    alreadySubmitted: 'ሥራው ቀድሞ ተልኳል',
    noAssignmentsFound: 'ለክፍልዎ የተሰጠ የቤት ሥራ የለም።',
    noMaterialsFound: 'ምንም የማጥኛ ማቴሪያሎች አልተገኙም።',
    parentCourseworkTitle: 'የቤት ሥራ እና የትምህርት ማቴሪያሎች',
    parentCourseworkSub: 'የ{name} የቤት ሥራዎችን፣ የተላኩ ምላሾችን፣ የመምህራን አስተያየቶችን እና የትምህርት ማቴሪያሎችን ይከታተሉ።',
    studentCourseworkTitle: 'የቤት ሥራ እና የትምህርት ማቴሪያሎች',
    studentCourseworkSub: 'የቤት ሥራዎን ያስገቡ፣ የመምህራን አስተያየቶችን ይመልከቱ እና የማጥኛ ማቴሪያሎችን ያውርዱ።',
    downloadDirectly: 'ማቴሪያሉን አውርድ',
    uploadSolutionFile: 'የመልስ ፋይል ስቀል',
    writeSolutionNotes: 'መልስ ወይም ማስታወሻ ጻፍ',
    submissionModalTitle: 'የቤት ሥራ ማስረከቢያ: {title}',
    fileAttached: 'ፋይል ተያይዟል',
    dragOrClickToUpload: 'ፋይል ለመስቀል ጠቅ ያድርጉ ወይም ይጎትቱ',
    allowedFileTypes: 'PDF, DOCX, ZIP, PNG, JPG (እስከ 25MB)',
    gradeScore: 'የተሰጠ ውጤት',
    teacherRemarks: 'የመምህሩ አስተያየት',
    ...
    // Reports Page
    reports: 'ሪፖርቶች',
    reportsTitle: 'የውጤት መግለጫ (ሪፖርት)',
    reportsSub: 'የትምህርት ውጤት መግለጫ መረጃ።',
    inPersonDistributionTitle: 'የውጤት መግለጫ (ሪፖርት ካርድ) በአካል የሚሰጥ ነው',
    inPersonDistributionNotice: 'ይፋዊ የውጤት መግለጫዎች በትምህርት ቤቱ ታትመው የሚሰጡ ናቸው። በዚህ ፖርታል በዲጂታል አይለቀቁም። ተማሪዎች ወደ ትምህርት ቤቱ መጥተው የተዘጋጀውን ሪፖርት ካርድ መውሰድ አለባቸው።',
    monitorPerformanceSubject: 'አፈጻጸምን በትምህርት ዓይነት ይከታተሉ',
    monitorPerformanceSubjectSub: 'በትምህርት ገጽ ላይ በማንኛውም ጊዜ የትምህርት አፈጻጸምዎን በትምህርት ዓይነት መከታተል ይችላሉ።',
    collectReportCard: 'ሪፖርት ካርድዎን ይውሰዱ',
    collectReportCardSub: 'በሥራ ሰዓት ወደ ትምህርት ቤቱ አስተዳደር ቢሮ በመምጣት የታተመውን ይፋዊ ሪፖርት ካርድዎን ይቀበሉ።',
    collectReportCardParentSub: 'እባክዎን በሥራ ሰዓት ወደ ትምህርት ቤቱ አስተዳደር ቢሮ በመምጣት የ{name} ይፋዊ ሪፖርት ካርድ ይቀበሉ።',
    goToAcademics: 'ወደ ትምህርት ገጽ ሂድ',
  },
  om: {
    // Navigation
    ...
    // Actions & Headers
    selectChild: "Barataa/ttuu Filadhu",
    ...
    loadingChild: "Galmee barataa/ttuu {name} fe'amaa jira...",
    couldNotLoad: "Odoo barataa/ttuu {name} fe'uu hin danda'amne.",
    noChildrenLinked: "Madaallii barataan/ttuun walqabatan hin jiran.",
    gpa: 'GPA',
    ...
    messageTeachersSub: "Barsiisota Barataa/ttuu keessaniif ramadamaniif ergaa dhuunfaa ergai.",
    loadingChildrenInfo: "Odeeffannoo barattootaa fe'amaa jira...",
    child: "Barataa/ttuu",
    noLinkedChildren: "Barataa/ttuun  walqabatan hin jiran",
    ...
    noTeachersFound: "Barataa/ttuu kanaaf barsiisonni hin argamne.",
    ...
    // Coursework & Materials
    coursework: 'Hojii Manaa fi Meeshaalee',
    assignments: 'Hojiiwwan Manaa',
    studyMaterials: 'Meeshaalee Qorannoo',
    submissions: 'Galchiiwwan',
    submitWork: 'Hojii Galchi',
    submitted: 'Ergameera',
    graded: 'Qabxiin kennameera',
    late: 'Bareeferama',
    overdue: 'Yeroon Darbe',
    dueDate: 'Guyyaa Dhumaa',
    points: 'Qabxii',
    feedback: 'Yaada',
    downloadFile: 'Fayilii Buusi',
    fileSubmission: 'Fayilii Galchuu',
    textNotesSubmission: 'Barreeffama Galchuu',
    submitAssignment: 'Hojii Manaa Galchi',
    turnInWork: 'Galchi',
    alreadySubmitted: 'Hojiin duraan ergameera',
    noAssignmentsFound: 'Hojii manaa kennamu hin jiru.',
    noMaterialsFound: 'Meeshaaleen qorannoo hin argamne.',
    parentCourseworkTitle: "Hojii Manaa fi Meeshaalee Qorannoo barataa/ttuu {name}",
    parentCourseworkSub: "Hojiiwwan manaa, sadarkaa galchii, yaada barsiisotaa fi meeshaalee qorannoo {name} hordofaa.",
    studentCourseworkTitle: "Hojii Manaa fi Meeshaalee Qorannoo",
    studentCourseworkSub: "Hojii manaa kee galchi, yaada barsiisotaa ilaali, meeshaalee barnootaa buufadhu.",
    downloadDirectly: 'Meeshaa Buufadhu',
    uploadSolutionFile: 'Fayilii Deebii Olkaa\'i',
    writeSolutionNotes: 'Deebii ykn Yaada Barreessi',
    submissionModalTitle: 'Hojii Manaa Galchuu: {title}',
    fileAttached: 'Fayiliin qabsiifameera',
    dragOrClickToUpload: 'Fayilii olkaa\'uuf cuqaasi ykn harkisi',
    allowedFileTypes: 'PDF, DOCX, ZIP, PNG, JPG (hanga 25MB)',
    gradeScore: 'Qabxii Argatame',
    teacherRemarks: 'Yaada Barsiisaa',
    daysLeft: 'Guyyoota {count} hafe',
    dueToday: 'Har\'a dhumata',
    closed: 'Cufameera',
    published: 'Maxxansameera',
    draft: 'Wixinee',

    // Reports Page
    reports: 'Gabaasaalee',
    reportsTitle: 'Kaardii Gabaasaa',
    reportsSub: 'Odeeffannoo kaardii gabaasa barnootaa.',
    inPersonDistributionTitle: 'Kaardiin Gabaasaa Qaamaan Kennama',
    inPersonDistributionNotice: 'Kaardiin gabaasaa seera qabeessi mana barumsaatiin maxxanfamee kennama. Poortaalii kanaan hin maxxanfamu. Barattoonni mana barumsaa dhufuun kaardii gabaasaa isaanii fudhachuu qabu.',
    monitorPerformanceSubject: 'Raawwii Barnootaa Gosaan Hordofaa',
    monitorPerformanceSubjectSub: 'Fuula Barnootaa irraa yeroo barbaaddanitti raawwii barnootaa gosa gosaan hordofuu dandeessu.',
    collectReportCard: 'Kaardii Gabaasaa Kee Fudhadhu',
    collectReportCardSub: 'Sa\'aatii hojiitti waajjira bulchiinsa mana barumsaa dhufuun kaardii gabaasaa kee fudhadhu.',
    collectReportCardParentSub: 'Sa\'aatii hojiitti waajjira bulchiinsa mana barumsaa dhufuun kaardii gabaasaa {name} fudhadhaa.',
    goToAcademics: 'Gara Fuula Barnootaatti Deemi',
  }
};
