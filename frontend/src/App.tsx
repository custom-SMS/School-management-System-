      ...
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/dashboard"
            element={
              <ProtectedRoute allowedRoles={["Teacher", "Student", "Parent", "Cashier"]}>
                <Dashboard />
              </ProtectedRoute>
            }
          />
          ...
          <Route path="/roles" element={<Navigate to="/super-admin/roles" replace />} />
          <Route path="/permissions" element={<Navigate to="/super-admin/permissions" replace />} />
          <Route path="/audit" element={<Navigate to="/super-admin/audit-logs" replace />} />
          ...
          <Route
            path="/report-card"
            element={
              <ProtectedRoute allowedRoles={["Teacher", "Student", "Parent", "SuperAdmin"]}>
                <ReportCard />
              </ProtectedRoute>
            }
          />
