...
// SuperAdmin + SchoolAdmin can manage Branches; all authenticated roles can read branches
router.get('/branches',      verifyToken, checkRole(['SuperAdmin', 'Admin', 'Teacher', 'Student', 'Parent', 'Cashier']), setCacheResource('branches'), globalCacheMiddleware, getBranches);
router.get('/branches/:id',  verifyToken, checkRole(['SuperAdmin', 'Admin', 'Teacher', 'Student', 'Parent', 'Cashier']), setCacheResource('branches'), globalCacheMiddleware, getBranchById);
...
// SuperAdmin + SchoolAdmin + BranchAdmin can manage Levels; Teachers/Admins can read
router.get('/branches/:branchId/levels', verifyToken, checkScope({ allowedScopes: ['SchoolAdmin','BranchAdmin'], allowedRoles: ['SuperAdmin', 'Admin', 'Teacher'] }), setCacheResource('branches'), globalCacheMiddleware, getLevelsByBranch);
