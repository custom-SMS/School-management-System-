...
const generateMonthlyFees = async (req, res) => {
  try {
    ...
    // Only check existing fees for students in THIS branch
    // (prevents cross-branch collision: Branch A cashier should not be affected
    //  by invoices already generated by Branch B cashier)
